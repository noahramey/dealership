...
describe('Vehicle') do
  ...
  describe('#make') do
    it('returns the make of the vehicle') do
      test_vehicle = Vehicle.new({:make => 'Honda', :model => 'Civic', :year => 2001, :color => 'blue', :engine_size => '4L', :number_of_doors =>
      '4'})
  ...
  describe('.find') do
    it('returns a vehicle by its id number') do
      ...
      '4'})
      test_vehicle.save()
      test_vehicle2 = Vehicle.new({:make => 'Toyota', :model => 'Corolla', :year => 1999, :color => 'red', :engine_size => '4L', :number_of_doors =>
      '4'})
      test_vehicle2.save()
